...
Model performance: the performance of the model will be assessed using metrics such as mean squared error, and R-squared. Cross validation (k-fold) will be implemented to evaluate the robustness of the model and also prevent overfitting. (SDG resource Centre, 2023)</h4> </p> 
